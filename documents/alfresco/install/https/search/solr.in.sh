...
SOLR_SSL_KEY_STORE=changeme_solr_keystore/ssl.repo.client.keystore
SOLR_SSL_KEY_STORE_PASSWORD=changeme_solr_password
SOLR_SSL_TRUST_STORE=changeme_solr_keystore/ssl.repo.client.truststore
SOLR_SSL_TRUST_STORE_PASSWORD=changeme_solr_password 
